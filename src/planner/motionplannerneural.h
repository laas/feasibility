...
struct MotionPlannerNeural: public MotionPlanner{
	...
	MotionPlannerNeural(Environment &env, int &argc, char** &argv): MotionPlanner(env){
		...
		ContactTransition::loadNNParameters("extern/fann/datasets/humanoids/");
...
Environment *MotionPlannerNeural::environment;
